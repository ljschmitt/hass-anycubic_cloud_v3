!function (t) {
  ...
  const et = (t, e) => {
    ...
    for (let e = 0; e < i; e++) {
      ...
      let a,
        ...
        l = -1,
        c = 0;
      for (; c < i.length && (o.lastIndex = c, h = o.exec(i), null !== h);) c = o.lastIndex, o === z ? "!--" === h[1] ? o = j : void 0 !== h[1] ? o = G : void 0 !== h[2] ? (X.test(h[2]) && (s = RegExp("</" + h[2], "g")), o = V) : void 0 !== h[3] && (o = V) : o === V ? ">" === h[0] ? (o = s ?? z, l = -1) : void 0 === h[1] ? l = -2 : (l = o.lastIndex - h[2].length, a = h[1], o = void 0 === h[3] ? V : '"' === h[3] ? W : Y) : o === W || o === Y ? o = V : o === j || o === G ? o = z : (o = V, s = void 0);
      const d = o === V && t[e + 1].startsWith("/>") ? " " : "";
      n += o === z ? i + F : l >= 0 ? (r.push(a), i.slice(0, l) + I + i.slice(l) + k + d) : i + k + (-2 === l ? e : d);
    }
  ...
  const Ct = t => new Et(+new Date(t)),
    ...
    Ht = 6e4,
    Mt = 36e5,
    It = Symbol.for("constructDateFrom");
  function kt(t, e) {
    return "function" == typeof t ? t(e) : t && "object" == typeof t && It in t ? t[It](e) : t instanceof Date ? new t.constructor(e) : new Date(e);
  }
  function Bt(t, e) {
    return kt(e || t, t);
  }
  ...
  const ue = {
    ...
    fe = {
      ...
      B: function (t, e, i) {
        const r = t.getHours();
        let s;
        switch (s = r >= 17 ? ye : r >= 12 ? be : r >= 4 ? me : ve, e) {
          case "B":
          case "BB":
          case "BBB":
            return i.dayPeriod(s, {
  ...
  function Be(t, e, i) {
    ...
    return h.map(r => {
      ...
      return (0, fe[n[0]])(a, n, s.localize, l);
    }).join("");
  }
  function Fe(t) {
    const e = t.match(Me);
  ...
  const Ge = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, Oe), Ue), Re), ze), je);
  var Ve, Ye;
  !function (t) {
        ...
        case Oe.ETA:
          return ((t, e, i) => {
            ...
            const r = e ? "" : ":ss",
              ...
              n = new Date();
            return n.setSeconds(n.getSeconds() + Number(t)), Be(n, s, {
              in: Ct
            });
          })(t, i, r);
        case Oe.Elapsed:
  ...
  const Ci = $i(class extends Ai {
    ...
    Ii = () => document.createComment(""),
    ki = (t, e, i) => {
      const r = t._$AA.parentNode,
        s = void 0 === e ? t._$AB : e._$AA;
      if (void 0 === i) {
        const e = r.insertBefore(Ii(), s),
          n = r.insertBefore(Ii(), s);
  ...
  var Rr = !!String.prototype.startsWith && "_a".startsWith("a", 1),
      ...
      switch (a) {
        ...
        case "time":
          ...
          if (this.bumpIf(",")) {
            ...
            if (0 === (g = es(v.val)).length) return this.error(ir.EXPECT_ARGUMENT_STYLE, Ur(this.clonePosition(), this.clonePosition()));
            l = {
              style: g,
  ...
  function ls(t) {
    t.forEach(function (t) {
      if (delete t.location, br(t) || yr(t)) for (var e in t.options) delete t.options[e].location, ls(t.options[e].value);else pr(t) && _r(t.style) || (gr(t) || mr(t)) && xr(t.style) ? delete t.style.location : fr(t) && ls(t.children);
    });
  }
  function cs(t, e) {
    void 0 === e && (e = {}), e = r({
  ...
  var xs,
    ...
    Es = function (t) {
      function e(e, i, r, s) {
        return t.call(this, 'Invalid values for "'.concat(e, '": "').concat(i, '". Options are "').concat(Object.keys(r).join('", "'), '"'), vs.INVALID_VALUE, s) || this;
      }
      return i(e, t), e;
    }(ws),
    Ss = function (t) {
      function e(e, i, r) {
        return t.call(this, 'Value for "'.concat(e, '" must be of type ').concat(i), vs.INVALID_VALUE, r) || this;
      }
      return i(e, t), e;
    }(ws),
    $s = function (t) {
      function e(e, i) {
        return t.call(this, 'The intl string context variable "'.concat(e, '" was not provided to the string "').concat(i, '"'), vs.MISSING_VALUE, i) || this;
      }
      return i(e, t), e;
    }(ws);
  function As(t) {
  ...
  function Cs(t, e, i, r, s, n, o) {
    ...
    for (var a = [], h = 0, l = t; h < l.length; h++) {
      ...
      if (dr(c)) a.push({
        type: xs.literal,
        value: c.value
      });else if (vr(c)) "number" == typeof n && a.push({
        type: xs.literal,
        ...
        if (ur(c)) u && "string" != typeof u && "number" != typeof u || (u = "string" == typeof u || "number" == typeof u ? String(u) : ""), a.push({
          ...
          if (br(c)) {
            if (!(v = c.options[u] || c.options.other)) throw new Es(c.value, u, Object.keys(c.options), o);
            a.push.apply(a, Cs(v.value, e, i, r, s));
          } else if (yr(c)) {
            var v;
            if (!(v = c.options["=".concat(u)])) {
              if (!Intl.PluralRules) throw new ws('Intl.PluralRules is not available in this environment.\nTry polyfilling it using "@formatjs/intl-pluralrules"\n', vs.MISSING_INTL_API, o);
              var f = i.getPluralRules(e, {
                type: c.pluralType
              }).select(u - (c.offset || 0));
              v = c.options[f] || c.options.other;
            }
            if (!v) throw new Es(c.value, u, Object.keys(c.options), o);
            a.push.apply(a, Cs(v.value, e, i, r, s, u - (c.offset || 0)));
          } else ;
        }
      }
    }
  ...
  })], Bs.prototype, "showVideo", void 0), s([yt({
    attribute: "toggle-video"
  })], Bs.prototype, "toggleVideo", void 0), s([yt({
    attribute: "camera-entity"
  })], Bs.prototype, "cameraEntity", void 0), s([vt()], Bs.prototype, "camImgString", void 0), Bs = s([xi("anycubic-printercard-camera_view")], Bs);
  const Ds = "secondary_",
  ...
  let Rs = class extends pt {
    constructor() {
      super(...arguments), this.box_id = 0, this.showControls = !0, this.allowSpoolEdit = !0, this._runoutRefillId = Ls, this._spoolsEntityId = Ns, this.spoolList = [], this.selectedIndex = -1, this.selectedMaterialType = "", this.selectedColor = [0, 0, 0], this._changingRunout = !1, this._openDryingModal = () => {
        ...
        const s = t.currentTarget.index,
          n = null !== (e = t.currentTarget.local_slot) && void 0 !== e ? e : s + 1,
          o = null !== (i = t.currentTarget.display_slot) && void 0 !== i ? i : n,
    ...
    render() {
      ...
      <div class="ac-printercard-mcbview">
        ${this.showControls ? K`
            ...
            ` : K`<div class="ac-printercard-mcbmenu"></div>`}
      ...
      return Fs(this.spoolList, (t, e) => {
        ...
        return K`
          <div
            class="ac-spool-info"
            .index=${e}
            .local_slot=${null !== (s = t.local_slot) && void 0 !== s ? s : e + 1}
            .display_slot=${o}
            .box_id=${null !== (n = t.box_id) && void 0 !== n ? n : this.box_id}
  ...
  s([yt()], Rs.prototype, "hass", void 0), s([yt()], Rs.prototype, "language", void 0), s([yt({
    attribute: "printer-entities"
  })], Rs.prototype, "printerEntities", void 0), s([yt({
    attribute: "printer-entity-id-part"
  })], Rs.prototype, "printerEntityIdPart", void 0), s([yt()], Rs.prototype, "box_id", void 0), s([yt({
    attribute: "spools-entity-id"
  })], Rs.prototype, "spoolsEntityId", void 0), s([yt({
    attribute: "show-controls",
    type: Boolean
  })], Rs.prototype, "showControls", void 0), s([yt({
    attribute: "allow-spool-edit",
    type: Boolean
  })], Rs.prototype, "allowSpoolEdit", void 0), s([vt()], Rs.prototype, "_runoutRefillId", void 0), s([vt()], Rs.prototype, "_spoolsEntityId", void 0), s([vt()], Rs.prototype, "spoolList", void 0), s([vt()], Rs.prototype, "selectedIndex", void 0), s([vt()], Rs.prototype, "selectedMaterialType", void 0), s([vt()], Rs.prototype, "selectedColor", void 0), s([vt()], Rs.prototype, "_runoutRefillState", void 0), s([vt()], Rs.prototype, "_buttonRefill", void 0), s([vt()], Rs.prototype, "_buttonDry", void 0), s([vt()], Rs.prototype, "_changingRunout", void 0), Rs = s([xi("anycubic-printercard-multicolorbox_view")], Rs);
  class zs {
    constructor(t) {
      this.scale_factor = t;
    }
    ...
    Zs = $i(class extends Ai {
      ...
      update(t, [e, i, r]) {
        ...
        let l,
          ...
          p = 0,
          g = n.length - 1;
        for (; d <= u && p <= g;) if (null === s[d]) d++;else if (null === s[u]) u--;else if (a[d] === o[p]) h[p] = Bi(s[d], n[p]), d++, p++;else if (a[u] === o[g]) h[g] = Bi(s[u], n[g]), u--, g--;else if (a[d] === o[g]) h[g] = Bi(s[d], n[g]), ki(t, h[g + 1], s[d]), d++, g--;else if (a[u] === o[p]) h[p] = Bi(s[u], n[p]), ki(t, s[d], s[u]), u--, p++;else if (void 0 === l && (l = Ks(o, p, g), c = Ks(a, d, u)), l.has(a[d])) {
          if (l.has(a[u])) {
            const e = c.get(o[p]),
              i = void 0 !== e ? s[e] : null;
            if (null === i) {
              const e = ki(t, s[d]);
              Bi(e, n[p]), h[p] = e;
            } else h[p] = Bi(i, n[p]), ki(t, s[d], i), s[e] = null;
            p++;
          } else Di(s[u]), u--;
        } else Di(s[d]), d++;
        for (; p <= g;) {
  ...
  s([yt({
    ...
    type: Boolean
  })], tn.prototype, "isSeconds", void 0), s([yt({
    type: Boolean
  })], tn.prototype, "running", void 0), s([vt()], tn.prototype, "currentTime", void 0), s([vt()], tn.prototype, "lastIntervalId", void 0), tn = s([xi("anycubic-printercard-stat-time")], tn);
  let en = class extends pt {
    ...
    willUpdate(t) {
      ...
      if (super.willUpdate(t), t.has("hass") || t.has("printerEntities") || t.has("printerEntityIdPart")) {
        ...
        this._valSpeedMode = s >= 0 && s in r ? r[s] : "Unknown", this._valFanSpeed = hi(this.hass, this.printerEntities, this.printerEntityIdPart, "fan_speed", 0).state, this._valDryStatus = li(this.hass, this.printerEntities, this.printerEntityIdPart, "drying_active", "Drying", "Not Drying", "unknown");
...
`;
  ...
  s([yt()], sn.prototype, "item", void 0), s([vt()], sn.prototype, "_isActive", void 0), sn = s([xi("anycubic-ui-select-dropdown-item")], sn);
  ...
  })], nn.prototype, "initialItem", void 0), s([vt()], nn.prototype, "_selectedItem", void 0), s([vt()], nn.prototype, "_active", void 0), s([vt()], nn.prototype, "_hidden", void 0), nn = s([xi("anycubic-ui-select-dropdown")], nn);
  const on = {
      keyframeOptions: {
        duration: 250,
        direction: "alternate",
  ...
  s([yt()], vn.prototype, "hass", void 0), s([yt()], vn.prototype, "language", void 0), s([yt({
    attribute: "selected-printer-device"
  })], vn.prototype, "selectedPrinterDevice", void 0), s([yt({
    attribute: "printer-entities"
  })], vn.prototype, "printerEntities", void 0), s([yt({
    attribute: "printer-entity-id-part"
  })], vn.prototype, "printerEntityIdPart", void 0), s([vt()], vn.prototype, "box_id", void 0), s([vt()], vn.prototype, "_dryingPresetId1", void 0), s([vt()], vn.prototype, "_dryingPresetId2", void 0), s([vt()], vn.prototype, "_dryingPresetId3", void 0), s([vt()], vn.prototype, "_dryingPresetId4", void 0), s([vt()], vn.prototype, "_dryingStopId", void 0), s([vt()], vn.prototype, "_hasDryingPreset1", void 0), s([vt()], vn.prototype, "_hasDryingPreset2", void 0), s([vt()], vn.prototype, "_hasDryingPreset3", void 0), s([vt()], vn.prototype, "_hasDryingPreset4", void 0), s([vt()], vn.prototype, "_hasDryingStop", void 0), s([vt()], vn.prototype, "_dryingPresetTemp1", void 0), s([vt()], vn.prototype, "_dryingPresetDur1", void 0), s([vt()], vn.prototype, "_dryingPresetTemp2", void 0), s([vt()], vn.prototype, "_dryingPresetDur2", void 0), s([vt()], vn.prototype, "_dryingPresetTemp3", void 0), s([vt()], vn.prototype, "_dryingPresetDur3", void 0), s([vt()], vn.prototype, "_dryingPresetTemp4", void 0), s([vt()], vn.prototype, "_dryingPresetDur4", void 0), s([vt()], vn.prototype, "_isOpen", void 0), s([vt()], vn.prototype, "_heading", void 0), s([vt()], vn.prototype, "_buttonTextPreset", void 0), s([vt()], vn.prototype, "_buttonTextMinutes", void 0), s([vt()], vn.prototype, "_buttonStopDrying", void 0), vn = s([xi("anycubic-printercard-multicolorbox_modal_drying")], vn);
  const fn = t => wn(255, Math.round(Number(t))),
    _n = t => fn(255 * t),
    xn = t => wn(1, t / 255),
  ...
  class $n {
    constructor(t, e, i, r) {
      return $n.isBaseConstructor(t) ? (this.r = fn(t.r), this.g = fn(t.g), this.b = fn(t.b), void 0 !== t.a && (this.a = En(t.a)), this) : $n.parse(t, e, i, r);
    }
    static parse(t, e, i, r) {
      if ($n.isBaseConstructor(t)) return new $n(t);
      if (void 0 !== e && void 0 !== i) {
        let s = fn(t);
        return e = fn(e), i = fn(i), void 0 !== r && (r = En(r)), new $n({
          r: s,
          g: e,
          b: i,
          a: r
...
`,
  ...
  class zn extends pt {
    ...
    set boundsX(t) {
      this._boundsX = Rn.fromString(t, On(this.target?.style.left ?? 0)), this.bounds.left = this._boundsX;
    }
    get boundsY() {
      return this._boundsY;
    }
    set boundsY(t) {
      this._boundsY = Rn.fromString(t, On(this.target?.style.top ?? 0)), this.bounds.top = this._boundsY;
    }
    static properties = {
      posLeft: {
        type: Number
  ...
  window.customElements.get("lit-movable") || window.customElements.define("lit-movable", zn);
  class jn extends pt {
    static properties = {
      color: {
        type: Object,
  ...
  const Gn = "anycubic_ha_integration",
    Vn = ["light"],
    Yn = ["switch"],
    Wn = ["camera"],
    Xn = {
  ...
  let Kn = class extends pt {
    constructor() {
      super(...arguments), this.box_id = 0, this.spoolList = [], this.spool_index = -1, this.display_slot = -1, this._isOpen = !1, this._changingSlot = !1, this._colourPresetChange = t => {
        ...
        var e;
        const i = t;
        i.stopPropagation(), i.detail.modalOpen && (this._isOpen = !0, this.box_id = Number(i.detail.box_id), this.spool_index = Number(i.detail.spool_index), this.display_slot = Number(null !== (e = i.detail.display_slot) && void 0 !== e ? e : this.spool_index + 1), this.material_type = _i(i.detail.material_type), this.color = i.detail.color);
  ...
  let to = class extends pt {
    constructor() {
      super(...arguments), this.monitoredStats = Jn, this.round = !0, this.temperatureUnit = Ne.C, this._showVideo = !1, this.cameraEntityState = void 0, this.isHidden = !1, this.isPrinting = !1, this.hiddenOverride = !1, this.hasColorbox = !1, this.hasSecondaryColorbox = !1, this.hasMaterialRack = !1, this.lightIsOn = !1, this.statusColor = "#ffc107", this.progressPercent = 0, this._togglingLight = !1, this._togglingPower = !1, this._toggleVideo = () => {
  ...
  })], eo.prototype, "unusedItems", void 0), s([yt()], eo.prototype, "reorder", void 0), s([yt()], eo.prototype, "toggle", void 0), s([vt()], eo.prototype, "_isActive", void 0), eo = s([xi("anycubic-ui-multi-select-reorder-item")], eo);
  ...
  s([yt({
    ...
    attribute: "on-change"
  })], io.prototype, "onChange", void 0), s([vt()], io.prototype, "_allOptions", void 0), s([vt()], io.prototype, "_selectedItems", void 0), s([vt()], io.prototype, "_unusedItems", void 0), io = s([xi("anycubic-ui-multi-select-reorder")], io);
  const ro = yi();
  ...
  }, s([yt()], t.AnycubicPrintercardEditor.prototype, "hass", void 0), s([yt()], t.AnycubicPrintercardEditor.prototype, "config", void 0), s([vt()], t.AnycubicPrintercardEditor.prototype, "printers", void 0), s([vt()], t.AnycubicPrintercardEditor.prototype, "language", void 0), t.AnycubicPrintercardEditor = s([xi("anycubic-card-editor")], t.AnycubicPrintercardEditor), t.AnycubicCard = class extends pt {
    constructor() {
      super(...arguments), this.config = {};
    }
    async firstUpdated() {
